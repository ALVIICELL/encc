...
u=`cat $infile | base64 | rev`

# now $u is the entire text file.

# secret encode

# ---

# x=$(eval $eLoP$Mll$GHi$v6T$Re$eLoP$v6T$RzE$v6T|$v6T$H2o$O2h$LcV"$LcV"$LcV"$Edo"$LcV|$v6T$O2h$r$v6T|$v6T$Gi$x$eLoP$u18$x64$v6T$Re$sfT);eval "$x"

# RzE="'$u'" <-- run the command
